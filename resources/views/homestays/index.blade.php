...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="flex justify-end mb-4">
        ...
        <form action="{{ route('homestays.index') }}"
              method="GET"
            ...
            <select
                name="sort"
                id="sort"
                class="text-sm border border-gray-300 rounded px-3 py-1.5 bg-white focus:outline-none"
            ...
            <div class="bg-white shadow rounded p-4 flex flex-col justify-between">
                ...
                <div>
                    ...
                    @if($home->reviews->count() > 0)
                        ...
                        <p class="text-yellow-500 text-sm font-medium mb-2">
                            ⭐ {{ number_format($home->reviews->avg('rating'), 1) }}/5
                            ({{ $home->reviews->count() }} Reviews)
                        </p>
                ...
                <div>
                    ...
                    <a href="/homestays/{{ $home->id }}"
                       class="text-blue-600 text-sm font-medium inline-block hover:underline mt-2">
